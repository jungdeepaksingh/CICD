...
app.use(express.static(__dirname + '/app/public')); // KULLANICILAR TARAFINDAfN ERİŞİLEBİLEfN KLASÖR TANIMLANDIupdatedangaffffindddupdaed
...
http.createServer(app).listen(app.get('port'), function(){
	console.log('Sistem ' + app.get('port') + ' Portu Üzerinde Çalışıycriid.');
});
